...
class AllArticleActivity : AppCompatActivity(), ArticleAdapter.OnArticleButtonClickListener {  // Pastikan implementasi listener di sini
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ArticleAdapter(articles, this)  // Kirim 'this' karena AllArticleActivity mengimplementasikan listener
        val recyclerView = findViewById<RecyclerView>(R.id.rvArticle)
